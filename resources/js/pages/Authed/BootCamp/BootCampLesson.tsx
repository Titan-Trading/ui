...
const BootCampLesson = () => {
    ...
    return (
        <>
            {/* Last course the user was working on */}
            {/* <LastCourseInProgress /> */}

            {/* Searchable list of other courses */}
